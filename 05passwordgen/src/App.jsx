  ...
  return (
   <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-gray-500'>
    ...
    <div className='flex shadow rounded-lg overflow-hidden mb-4'>
      <input type="text" value={password} className='outline-none w-full py-1 px-3 bg-white' placeholder='Enter Password' readOnly/>
    ...
    <div className='flex text-sm gap-x-2'>
      <input type="checkbox" /> <label htmlFor="Length">length: {length}</label>
    </div>
   </div>
  )
}
